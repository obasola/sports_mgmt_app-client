<!-- src/components/playeraward/PlayerAwardCreateForm.vue -->
...
const onSubmit = async () => {
  try {
    await playerAwardStore.create(form)
    toast.add({
      severity: 'success',
      summary: 'Success',
      detail: 'Player Award created successfully',
    })
    ...
    toast.add({
      severity: 'error',
      summary: 'Error',
      detail: 'Failed to create player award',
    })
  }
}
...
<template>
  <Card class="create-form">
    <template #title>Create New Player Award</template>
